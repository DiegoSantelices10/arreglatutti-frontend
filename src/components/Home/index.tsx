...
const HomeUI = async () => {
  ...
  return (
    <>
      <section
        id="home"
        className="relative z-10 overflow-hidden pt-[120px] pb-10 px-4 md:px-10"
      >
        ...
        <div className="lg:flex lg:gap-4 lg:justify-center lg:items-center">
          <div className="pb-6 md:px-2">
            ...
            >
              <div className="w-full">
                ...
                <p className="mb-12 mt-1 text-sm font-normal text-body-white text-[#bed3ff]">
          ...
          <div className="w-full lg:w-1/2 mt-4 md:mt-0 md:pl-10">
            <div
              ...
              data-wow-delay=".15s"
            >
              <h2 className="mb-3 text-2xl font-bold text-secondary text-center">
